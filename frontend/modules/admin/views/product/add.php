...
<div class="x-body">
	<form class="layui-form">
			...
			<div class="layui-input-inline">
                <select name="cateid" xm-select="cate" xm-select-radio="" xm-select-search="" xm-select-search-type="dl">
					...
					<? foreach ($cates as $cate): ?>
						<option value="<? echo $cate['id'] ?>"><? echo $cate['title'] ?></option>
					<? endforeach; ?>
				</select>
			</div>
            ...
            <div class="layui-input-inline">
                <select name="featuredid" lay-filter="">
					...
					<? foreach ($featureds as $f): ?>
                        <option value="<? echo $f['id'] ?>"><? echo $f['title'] ?></option>
					<? endforeach; ?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
            <textarea class="layui-textarea" name="abstract" type="text/plain">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" name="num" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" name="price" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" name="saleprice" required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input value="1" type="checkbox" name="issale" lay-skin="switch" lay-text="ON|OFF">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">热门</label>
            <div class="layui-input-block">
                <input value="1" type="checkbox" name="ishot" lay-skin="switch" lay-text="ON|OFF">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">新品</label>
            <div class="layui-input-block">
                <input value="1" type="checkbox" name="isnew" lay-skin="switch" lay-text="ON|OFF">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
