...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <input id="qrpass" name="qrpass" type="password" class="form-control pword m-b" placeholder="确认密码"/>
            <button id="submit" class="btn btn-success btn-block">确定</button>
        </div>
    </div>
...
<script>
    ...
    $("#submit").click(function(){
        ...
        //var code = $("#code").val();
        //console.log(name);
        var url = "<?php echo yii\helpers\Url::to(['site/mailchangepass'])?>";
        $.ajax({
            url : url,
            async: false,
            type : "post",
